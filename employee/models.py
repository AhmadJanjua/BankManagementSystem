...
class EmployeeManager(BaseUserManager):
    def create_employee(self, password, ssn, f_name, l_name, birthday, street, city, province, postal_code, department,
        ...
        employee = self.model(ssn=ssn, f_name=f_name, l_name=l_name, birthday=birthday, street=street, city=city,
                              province=province, postal_code=postal_code, department=department, supervisor=supervisor,
                              **extra_fields)
        employee.set_password(password)
        employee.save(using=self._db)
        return employee

    def create_advisor(self, password, ssn, f_name, l_name, birthday, street, city, province, postal_code, department,
    ...
    def create_teller(self, ssn, f_name, l_name, birthday, street, city, province, postal_code, department,
    ...
    def create_manager(self, password, ssn, f_name, l_name, birthday, street, city, province, postal_code, department,
                       supervisor=None, **extra_fields):
    ...
    def create_admin(self, password, ssn, f_name, l_name, birthday, street, city, province, postal_code, department,
                     **extra_fields):
        extra_fields.setdefault('is_staff', True)
        extra_fields.setdefault('is_superuser', True)
        return self.create_employee(ssn=ssn, f_name=f_name, l_name=l_name, birthday=birthday, street=street, city=city,
                                    province=province, postal_code=postal_code, department=department, **extra_fields)
